...
function custom_post_example() { 
	...
	register_post_type( 'meat_press', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Meat Press', 'jointstheme'), /* This is the Title of the Group */
			...
			'rewrite'	=> array( 'slug' => 'meat_press', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'meat_press', /* you can rename the slug here */
	...
	// creating (registering) the custom type 
	register_post_type( 'supporters', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			...
			'menu_position' => 8, /* this is what order you want it to appear in on the left hand side menu */ 
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/custom-post-icon.png', /* the icon for the custom post type menu */
			'rewrite'	=> array( 'slug' => 'supporters', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'supporters', /* you can rename the slug here */
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
			'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'sticky')
